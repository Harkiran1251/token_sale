...
contract('Dapptoken', function (accounts) {
    var tokenInstance;
    it('inititalizes the contract with correct values',function(){
    ...
    it('allocates the initial supply upon deployment', function () {
        return DappToken.deployed().then(function (instance) {
            ...
            assert.equal(adminBalance.toNumber(), 1000000, 'it allocate sthe initial supply ot the admin');
        });
   ...
   it('transfers token ownership', function() {
       return DappToken.deployed().then(function (instance) {
           ...
           assert(error.message.indexOf('revert') >= 0, 'error message must contain revert');
                   ...
                   assert(error.message.indexOf('revert') >= 0, 'error messagemust contain revert');
   ...
   it('handles delegated token transfers', function() {
       return DappToken.deployed().then(function(instance) {
           ...
           assert.equal(allowance.toNumber(), 0, 'it deducts amount fromthe allowance');
       });
